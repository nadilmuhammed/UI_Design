  ...
  return (
    <>
        <div style={{width:"100%",height:"100vh", display:"flex",justifyContent:"center",alignItems:'center'}}>
            <div style={{width:"80%",height:"80vh", backgroundColor:"rgb(207 215 230)",borderRadius:"2rem",display:"flex",justifyContent:"center"}}>
                <div style={{width:"60%", display:"flex",justifyContent:"center",flexDirection:"column"}}>
                    <div style={{display:"flex",alignItems:"center",gap:"2rem"}}>
                        <div>
                            <FaSquareFull style={{color:"#0000ff"}} />
                        </div>
                        <div>
                            <p  style={{fontWeight:"bold"}}>The Best AI Service Provider</p>
                        </div>
                    </div>
                    <p><span>Crafting Tomorrow's World</span><br/>With <span style={{color:"#004eff"}}>AI Excellence   </span></p>
